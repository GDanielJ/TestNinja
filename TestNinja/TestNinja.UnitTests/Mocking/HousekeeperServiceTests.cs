...
namespace TestNinja.UnitTests.Mocking
{
    ...
    public class HousekeeperServiceTests
    {
        ...
        [Test]
        public void SendStatementEmails_StatementFilenameIsNull_DoNotEmailTheStatement()
        {
        ...
        [Test]
        public void SendStatementEmails_StatementFilenameIsEmptyString_DoNotEmailTheStatement()
        {
            _statementFileName = "";
        ...
        [Test]
        public void SendStatementEmails_StatementFilenameIsWhiteSpace_DoNotEmailTheStatement()
        {
            _statementFileName = " ";
